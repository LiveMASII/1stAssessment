...
let highestProductV = null
let highestProductI = -1

for (let i = 0; i < numsList.length; i++){
  let currentP = getProduct(numsList[i])

  if (currentP > highestProductV){
    highestProductV = currentP
    highestProductI = i
  }
}
  return highestProductI
}
